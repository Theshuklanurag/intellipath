      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass rounded-3xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full py-3 justify-center" style={{ fontSize: 14 }}>
              {loading
                ? <div className="loader" style={{ width: 16, height: 16, borderWidth: 2 }} />
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'var(--text-muted)' }}>
            ...
            <Link to="/signup" style={{ color: 'var(--cyan)' }} className="font-semibold">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
