...
export default function SignupPage() {
  ...
  const handleOAuth = async (provider) => {
    ...
    try {
      ...
      if (!supabase) { toast.error('OAuth not configured'); setOauthLoading(''); return }
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-6">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center"
              ...
              <Zap className="w-5 h-5" style={{ color: '#000' }} fill="#000" />
            </div>
          ...
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Start your AI-powered journey</p>
        </div>
        ...
        <div className="glass rounded-3xl p-8">
          ...
          <div className="space-y-3 mb-6">
            {[
              ...
              <button key={provider} onClick={() => handleOAuth(provider)} disabled={!!oauthLoading}
                ...
                style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border)', color: 'var(--text-primary)', opacity: oauthLoading && oauthLoading !== provider ? 0.5 : 1 }}
          ...
          <div className="flex rounded-xl overflow-hidden mb-6" style={{ border: '1px solid var(--border)' }}>
            {['student','teacher'].map(role => (
              <button key={role} onClick={() => set('role', role)}
                ...
                style={{
                  background: form.role === role ? 'linear-gradient(135deg,#00D4FF,#0077FF)' : 'transparent',
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input className="inp" placeholder="+91 XXXXXXXXXX"
